...
class LBaaSv2BaseDriver(object):
    ...
    def create_loadbalancer(self, vip, service):
        """LBaaSv2 Create Loadbalancer."""
        raise NotImplementedError()

    def update_loadbalancer(self, old_vip, vip, service):
        """LBaaSv2 Update Loadbalancer."""
        raise NotImplementedError()

    def delete_loadbalancer(self, vip, service):
        """LBaaSv2 Delete Loadbalancer."""
        raise NotImplementedError()

    def create_listener(self, vip, service):
        """LBaaSv2 Create Listener."""
        raise NotImplementedError()

    def update_listener(self, old_vip, vip, service):
        """LBaaSv2 Update Listener."""
        raise NotImplementedError()

    def delete_listener(self, vip, service):
        """LBaaSv2 Delete Listener."""
        raise NotImplementedError()
    ...
    def create_member(self, member, service):
        """LBaaSv2 Create Member."""
        raise NotImplementedError()

    def update_member(self, old_member, member, service):
        """LBaaSv2 Update Member."""
        raise NotImplementedError()

    def delete_member(self, member, service):
        """LBaaSv2 Delete Member."""
        raise NotImplementedError()

    def create_health_monitor(self, health_monitor, pool, service):
        """LBaaSv2 Create Pool Health Monitor."""
        raise NotImplementedError()
